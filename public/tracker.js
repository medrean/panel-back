(function () {
    ...
    // ⛔ لا قيمة افتراضية — كان 'site_cars_01' يُنشئ موقعاً وهمياً يعود بعد حذفه
    const siteKey = (currentScript && currentScript.getAttribute('data-site')) || '';
    if (!siteKey) {
        console.warn('[SaaS Hub] ⚠️ لم يُحدَّد data-site في وسم السكربت — لن يُسجَّل الموقع في اللوحة.\n' +
            '    مثال: <script src="https://hub/tracker.js" data-site="site_xxx"></script>');
    }
